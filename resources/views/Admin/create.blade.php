                      ...
                      <div class="card-body card-block">
                        <form action="{{route('admin.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="name" placeholder="Text" class="form-control"><small class="help-block form-text">Input full name</small></div>
                          </div>
                          ...
                          <div class="row form-group">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text"  name="company_name" placeholder="Company Name" class="form-control"><small class="help-block form-text">Input Company/Shop Name</small></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="Company address" class=" form-control-label">Company address</label></div>
                            <div class="col-12 col-md-9"><input type="text"  name="company_address" placeholder="Company Address" class="form-control"><small class="help-block form-text">Input Company address</small></div>
                      </div>                          
