            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Manage Categories</a>
                     ...
                     {{--   <li class="active">
                        <a href="#"> <i class="fas fa-address-card"></i> &ensp; Manage Categories </a>
                    </li> --}}
                    <br>
