...
<head>
    ...
    <title>{{ config('app.name', 'Multivendor') }} {{ ucfirst(config('multiauth.prefix')) }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container" >
                <a class="navbar-brand" href="{{ route('admin.home') }}">
                    {{ config('Admin', 'Multivendor') }} {{ ucfirst(config('multiauth.prefix')) }}
                </a>
