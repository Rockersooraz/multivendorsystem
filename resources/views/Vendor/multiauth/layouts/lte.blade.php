...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Multi</b>Vendor</span>
    </a>
              ...
              <li class="user-footer">
                <div class="pull-left">
                 {{--  <a href="#" class="btn btn-default btn-flat">Profile</a> --}}
                   @admin('super')
                                    <a class="btn btn-default btn-flat" href="{{ route('admin.show') }}">{{ ucfirst(config('multiauth.prefix')) }}</a> &nbsp &nbsp &nbsp &nbsp &nbsp
                                    <a class="btn btn-default btn-flat" href="{{ route('admin.roles') }}">Roles</a>
                                @endadmin
                </div>
...
<i class="fa fa-fw fa-shopping-cart"></i>
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fas fa-plus-circle"></i> Add Products</a></li>
          </ul>
        </li>
        ...
        <li><a href="{{route('admin.merchant.detail')}}"><i class="fas fa-user-friends"></i> <span>Vendors</span></a></li>
...
@show
  ...
  <footer class="main-footer">
    ...
    <strong>Multivendor Admin <!-- <a href="https://adminlte.io">Almsaeed Studio</a> --></strong> 
  </footer>
